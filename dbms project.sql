...
INSERT INTO TRAIN VALUES(123,"Nalgonda","Hyderabad"),(124,"Mangalore","Bengalore"),(125,"Bengalore","Mangalore"),(126,"Ongole","Guntur"),(127,"Nalgonda","Hyderabad");
Insert INTO STATION VALUES(123,"Hyderabad",'23:00:00'),(124,"Mangalore",'00:15:00'),(123,"Nalgonda",'02:10:00'),(125,"Guntur",'15:30:00'),(127,"Nalgonda",'3:45:00'),(127,"Hyderabad",'15:30:00');
...
INSERT INTO USERS VALUES(1,21,20,0,'SLEEPER',123,'2024-03-26');
...
SELECT * FROM USERS;
 ...
 SELECT TRAIN.T_NO,STOP,STOP_TIME FROM TRAIN JOIN STATION WHERE START_S='Nalgonda' AND END_S='Hyderabad' order by TRAIN.T_NO ;
